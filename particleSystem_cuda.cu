...
extern "C"
{
                         ...
                         uint numParticles)
    {
        ...
        thrust::device_ptr<float4> d_len4((float4 *)len);

        thrust::for_each(
            thrust::make_zip_iterator(thrust::make_tuple(d_pos4, d_vel4, d_len4)),
            thrust::make_zip_iterator(thrust::make_tuple(d_pos4+numParticles, d_vel4+numParticles, d_len4+numParticles)),
                                     ...
                                     uint   numCells)
    {
        ...
        checkCudaErrors(cudaBindTexture(0, oldLenTex, oldLen, numParticles*sizeof(float4)));
#endif
        ...
        checkCudaErrors(cudaUnbindTexture(oldLenTex));
#endif
    }
